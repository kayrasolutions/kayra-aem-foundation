...
/**
 * Text/value pair for displaying in a selection dialog widget, used in
 * conjunction with the <code>AbstractOptionsProviderServlet</code>.
 */
public final class Option {
	...
	public static List<Option> fromMap(final Map<String, String> map) {
		return map.entrySet().stream().map(entry -> new Option(entry.getKey(), entry.getValue()))
