package com.kayrasolutions.aem.foundation.core.constants;
...
public final class ComponentConstants {
	...
	/**
	 * Edit bar property. Displays the static text value, e.g. to show "Breadcrumb"
	 * in the edit bar for a component, you would use EDIT_BAR_TEXT + "Breadcrumb".
	 */
	...
	/**
	 * Edit bar property. Adds an edit button to the edit bar that, when clicked,
	 * will open up the edit dialog for the component.
	 */
	public static final String EDIT_BAR_EDIT = "edit";

	/**
	 * Edit bar property. Adds a delete button to the edit bar that, when clicked,
	 * will delete the component.
	 */
	public static final String EDIT_BAR_DELETE = "delete";

	/**
	 * Edit bar property. Adds an insert button to the edit bar that, when clicked,
	 * will allow a new component to be inserted above the current one.
	 */
	public static final String EDIT_BAR_INSERT = "insert";

	/**
	 * Edit bar property. Adds an annotate button to the edit bar that, when
	 * clicked, allows the component to be annotated.
	 */
	public static final String EDIT_BAR_ANNOTATE = "annotate";

	/**
	 * Edit bar property. Adds a copy/cut button to the edit bar that, when clicked,
	 * allows the component to be moved.
	 */
	...
	/**
	 * Name of event to be fired after successfully inserting a new component
	 * instance.
	 */
	...
	/**
	 * Name of event to be fired after successfully insert a child component
	 * instance.
	 */
	...
	/**
	 * Name of event to be fired when component is ready (rendered and events
	 * attached).
	 */
