package com.kayrasolutions.aem.foundation.core.resource;
...
/**
 * Extendable class that delegates to a <code>ComponentResource</code> instance.
 * Use when instantiating component resource instances directly (i.e. not in the
 * context of a JSP or HTL request).
 */
