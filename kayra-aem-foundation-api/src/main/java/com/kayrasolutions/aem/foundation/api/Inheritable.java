...
/**
 * An accessible instance (such as a <code>Resource</code> or <code>Page</code>)
 * that supports hierarchy-based content inheritance.
 */
public interface Inheritable {

	/**
	 * Given a property on this node containing the path of another resource, get
	 * the href to the resource, using inheritance if the value does not exist on
	 * this component.
	 *
	 ...
	 * Given a property on this node containing the path of another resource, get
	 * the href to the resource, using inheritance if the value does not exist on
	 * this component. Use this method with a <code>true</code> argument when
	 * appending ".html" to the resource path is desired only for valid CQ pages and
	 * not external paths.
	 *
	 * @param propertyName name of property containing a valid content path
	 ...
	 * this component. Use this method with a <code>true</code> argument when
	 * appending ".html" to the resource path is desired only for valid CQ pages and
	 * not external paths. Setting <code>mapped</code> to <code>true</code> will map
	 * the path value, if it exists, through the Sling Resource Resolver.
	 *
	 * @param propertyName name of property containing a valid content path
	 * @param strict       if true, strict resource resolution will be applied and
	 *                     only valid CQ content paths will have ".html" appended
	...
	/**
	 * Given a property on this node containing the path of another resource, get a
	 * link to the resource, using inheritance if the value does not exist on this
	 * component.
	 *
	 * @param propertyName name of property containing a valid content path
	 * @return <code>Optional</code> link object, or null if the property does not
	 ...
	 * Given a property on this node containing the path of another resource, get a
	 * link to the resource, using inheritance if the value does not exist on this
	 * component. Use this method with a <code>true</code> argument when including
	 * an extension for the link is desired only for valid CQ pages and not external
	 * paths.
	 *
	 * @param propertyName name of property containing a valid content path
	 * @param strict       if true, strict resource resolution will be applied and
	 ...
	 * component. Use this method with a <code>true</code> argument when including
	 * an extension for the link is desired only for valid CQ pages and not external
	 * paths. Setting <code>mapped</code> to <code>true</code> will map the path
	 * value, if it exists, through the Sling Resource Resolver.
	 *
	 * @param propertyName name of property containing a valid content path
	 * @param strict       if true, strict resource resolution will be applied and
	 *                     only valid CQ content paths will have an extension
	 ...
	 * type, using inheritance if the value does not exist on this component.
	 *
	...
	/**
	 * Get a page from the value of the given property, using inheritance if the
	 * value does not exist on this component. The property value will be localized
	 * to the current page context before getting the page.
	 *
	...
	/**
	 * Get a multi-valued property from the current resource as a list of pages,
	 * using inheritance if the value does not exist on this component.
	 *
	 * @param propertyName name of property containing a list of page paths
	 * @return list of pages, or empty list if either the property does not exist or
	 *         pages do not exist for the property values
	 */
	 ...
	 * resource containing the path of another <code>Resource</code>, using
	...
	/**
	 * Get a multi-valued property from the current resource as a list of resources,
	 * using inheritance if the value does not exist on this component.
	 *
	 ...
	 *         exist or does resolve to a list of resources
	 */
	 ...
	 * containing the path of another <code>Resource</code> in the repository, using
	 * inheritance if the value does not exist on this component.
	 *
	 * @param propertyName  name of property containing a resource path
	...
	/**
	 * Get a multi-valued property from the current resource as a list of the given
	 * type, using inheritance if the value does not exist on this component.
	 *
	 * @param propertyName  name of property containing a list of resource paths
	 * @param type          type to adapt from resource corresponding to each path
	 *                      value
	 * @param <AdapterType> adapter class that is adaptable from
	 *                      <code>Resource</code>
	 * @return list of the specified type, or empty list if either the property does
	 *         not exist or the resource does not adapt to the provided type
	 */
	<AdapterType> List<AdapterType> getAsTypeListInherited(String propertyName, Class<AdapterType> type);

	/**
	 * @param isSelf if true, component will attempt to find the image reference
	 *               property on the current resource
	...
	/**
	 * Get a property value from the current node. If no value is found, traverse up
	 * the content tree respective to the page and relative node path until a value
	 * is found.
	 *
	 * @param <T>          result type
	 ...
	 * Get a property value from the current node. If no value is found, traverse up
	 * the content tree respective to the page and relative node path until a value
	 * is found, returning an absent <code>Optional</code> if not. This returns the
	 * same value as the underlying <code>ValueMap</code> wrapped in an
	 * <code>Optional</code> instance instead of returning null.
	 *
	 * @param propertyName property name
	 * @param type         property type
	 * @param <T>          type
	 * @return <code>Optional</code> of the given type containing the property value
	 *         or absent if no value is found
	 */
	<T> Optional<T> getInherited(String propertyName, Class<T> type);

	/**
	 * Get a list of tags for the given property name. If no tags are found,
	 * traverse up the content tree respective to the page and relative path until a
	 * value is found, returning an empty list if not.
	 *
	...
	/**
	 * Get a child resource relative to the current resource, inheriting from a
	 * parent page if it does not exist.
	 *
	 * @param relativePath path relative to current resource
	 * @return direct child resource if it exists, otherwise the child resource at
	 *         this relative path for an ancestor page
	 */
	Optional<ComponentResource> getComponentResourceInherited(String relativePath);

	/**
	 * Get the children of the current resource. If the current resource has no
	 * children, inherit from an ancestor page.
	 *
	 * @return list of resources representing children of the current resource or
	 *         inherited from an ancestor page (or empty list if none exist)
	 */
	List<ComponentResource> getComponentResourcesInherited();

	/**
	 * Get the children of the current resource meeting the predicate condition. If
	 * the current resource has no children, inherit from an ancestor page.
	 *
	...
	/**
	 * Get the children of a resource relative to the current resource. If resource
	 * does not exist relative to current page, inherit from a parent page.
	 *
	 * @param relativePath path relative to current resource
	 * @return list of resources representing children of the addressed resource or
	 *         inherited from a parent page (or empty list if none exist)
	 */
	List<ComponentResource> getComponentResourcesInherited(String relativePath);

	/**
	 * Get the children of a resource relative to the current resource meeting the
	 * predicate condition. If resource does not exist relative to current page,
	 * inherit from a parent page.
	 *
	 * @param relativePath path relative to current resource
	 * @param predicate    predicate used to filter resources
	 * @return list of resources representing children of the addressed resource or
