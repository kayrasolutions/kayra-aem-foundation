...
public interface Traversable<T> {
	 ...
	 *
	 * @param predicate              predicate to match ancestor resources against
	 * @param excludeCurrentResource if true, the current resource will be excluded
	 *                               (i.e. even if the current resource matches the
	 *                               predicate criteria, it will not be returned)
	 * @return <code>Optional</code> resource that matches the predicate condition
	 */
	...
	/**
	 * Find the first ancestor resource where the given property name has the
	 * specified value.
	 *
	 * @param propertyName  property name to find on ancestor resources
	 ...
	 * @return list of resources that match the predicate condition or empty list if
	 *         none exist
	 */
