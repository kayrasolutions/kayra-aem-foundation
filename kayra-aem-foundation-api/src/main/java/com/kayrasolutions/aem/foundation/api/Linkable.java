...
public interface Linkable {
	 ...
	 *
	 * @param mapped if true, the path will be routed through the resource resolver
	 *               to determine the mapped path (e.g. without leading "/content").
	 * @return mapped href
	 */
	 ...
	 * Get a link for this item.
	 *
	 * @param mapped if true, the <code>Link</code> path will be routed through the
	 *               resource resolver to determine the mapped path (e.g. without
	 *               leading "/content").
	 * @return mapped link
	 */
	 ...
	 *
	 * @param mapped if true, the <code>LinkBuilder</code> for this resource will be
