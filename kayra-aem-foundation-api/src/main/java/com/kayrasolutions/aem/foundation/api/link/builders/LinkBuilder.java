package com.kayrasolutions.aem.foundation.api.link.builders;
...
/**
 * Builder for creating <code>Link</code>, <code>ImageLink</code>, and
 * <code>NavigationLink</code> objects.
 */
public interface LinkBuilder {
	...
	/**
	 * Add properties (map of properties name-value pairs that are stored on the
	 * returned link instance).
	 *
	...
	/**
	 * Add a property (arbitrary name-value pair stored on the returned link
	 * instance).
	 *
	...
	/**
	 * Set whether the link should be considered external, i.e. not a valid content
	 * path.
	 *
	...
	/**
	 * Set the host. If the host is set, the href of the built link will be absolute
	 ...
	 * <p>
	 * If set, the scheme will override the default value of "http" (or "https" if
	 * secure=true).
	 *
	 * @param scheme scheme
	 * @return builder
	...
	/**
	 * Set whether the link URI is opaque (an absolute URI whose scheme-specific
	 * part does not begin with a slash character).
	 *
	 * @param isOpaque if true, ":" instead of "://" will be appended to the scheme
	 *                 for external links (e.g. "mailto:" links)
	 * @return builder
	 */
	...
	/**
	 * Set secure. If true, the returned link will be "https" instead of "http".
	 * This only applies when a host name is set.
	 *
