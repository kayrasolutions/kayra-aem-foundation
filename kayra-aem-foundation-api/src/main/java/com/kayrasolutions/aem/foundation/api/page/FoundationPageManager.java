...
/**
 * Decorates the <code>PageManager</code> interface with additional methods for
 * finding pages using queries, tags, and template paths.
 */
public interface FoundationPageManager extends PageManager {
	 ...
	 *
	 * @param rootPath  root path
	 * @param predicate predicate to determine if a page should be included in the
	 *                  result list
	...
	/**
	 * Copies the given page to the new destination and automatically saves the
	 * modifications
	 *
	 * @param page            the page to copy
	 * @param destination     the destination
	 * @param beforeName      the name of the next page. if <code>null</code> the
	 *                        page is ordered at the end.
	 * @param shallow         if <code>true</code> a non-recursive copy is
	 *                        performed.
	...
	/**
	 * Creates a new page at the given path using the provided template as content
	 * template. If a no pageName is given but a title, then the title is used as
	 * hint for the name of the new page.
	 *
	...
	/**
	 * Returns the page that contains this resource. If the resource is a page the
	 * resource is returned. Otherwise it walks up the parent resources until a page
	 * is found.
	 *
	...
	/**
	 * Returns the page that contains the resource at the given path. If the path
	 * addresses a page, that page is returned. Otherwise it walks up the parent
	 * resources until a page is found.
	 *
	...
	/**
	 * Convenience method that returns the page at the given path. If the resource
	 * at that path does not exist or is not adaptable to Page, <code>null</code> is
	 * returned.
	 *
	...
	/**
	 * Moves the given page to the new destination. If source and destination are
	 * equals the page is just ordered.
	 *
